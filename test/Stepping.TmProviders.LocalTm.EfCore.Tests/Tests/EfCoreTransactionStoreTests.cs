...
namespace Stepping.TmProviders.LocalTm.EfCore.Tests.Tests;

public class EfCoreTransactionStoreTests : SteppingTmProvidersLocalTmEfCoreTestBase
{
    ...
    public EfCoreTransactionStoreTests()
    {
        TransactionStore = ServiceProvider.GetRequiredService<EfCoreTransactionStore>();
    ...
    public async Task Should_Not_Create_Transaction_If_Gid_Exists()
    {
        ...
        await Should.ThrowAsync<DbUpdateException>(async () => await TransactionStore.CreateAsync(existModel));
    }
    ...
    public async Task Should_Not_Update_Transaction_If_ConcurrencyStamp_Not_Match()
    {
        ...
        await Should.ThrowAsync<DbUpdateException>(async () => await TransactionStore.UpdateAsync(existModel));
    }
